...
/**
 * About section with build info and localization credits.
 */
export { default as SettingsChatAbout } from './SettingsChat/SettingsChatAbout.svelte';

/**
 * Language selection control shown in the Display settings section.
 */
export { default as SettingsChatLanguage } from './SettingsChat/SettingsChatLanguage.svelte';
