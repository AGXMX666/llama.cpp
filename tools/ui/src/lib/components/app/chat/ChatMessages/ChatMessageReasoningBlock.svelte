<script lang="ts">
	...
	const REASONING_HEADER = $derived(t('Reasoning'));
	const REASONING_HEADER_PENDING = $derived(t('Reasoning...'));
	const REASONING_SUBTITLE_ERROR = $derived(t('Error'));
	const REASONING_SUBTITLE_CANCELLED = $derived(t('Cancelled'));
