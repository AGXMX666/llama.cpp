						...
						<Table.Body>
							...
							{#if serverProps?.default_generation_settings?.n_ctx}
								<Table.Row>
									...
									<Table.Cell
										>{formatNumber(serverProps.default_generation_settings.n_ctx)} {t('tokens')}</Table.Cell
									>
								</Table.Row>
							{:else}
								<Table.Row>
							...
							{#if modelMeta?.n_ctx_train}
								<Table.Row>
									...
									<Table.Cell>{formatNumber(modelMeta.n_ctx_train)} {t('tokens')}</Table.Cell>
								</Table.Row>
							{/if}
							...
							{#if modelMeta?.n_vocab}
								<Table.Row>
									...
									<Table.Cell>{formatNumber(modelMeta.n_vocab)} {t('tokens')}</Table.Cell>
								</Table.Row>
							{/if}
